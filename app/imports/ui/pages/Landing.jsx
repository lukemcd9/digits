  ...
  render() {
    return (
        <div className='digits-background'>
            <Grid container stackgable centered columns={3}>
                <Grid.Column textAlign='center'>
                    <Icon size='huge' inverted name='users'/>
                    <Header as='h1' inverted>Multiple Users</Header>
                    <Header as='h3' inverted>
                        This address book enables any numbers of users to register and save their business contacts.
                        You can only see the contacts you have created.
                    </Header>
                </Grid.Column>

                <Grid.Column textAlign='center'>
                    <Icon size='huge' inverted name='file alternate'/>
                ...
                <Grid.Column textAlign='center'>
                    <Icon size='huge' inverted name='stopwatch'/>
                    <Header as='h1' inverted>Timestamped Notes</Header>
                    <Header as='h3' inverted>
                        Each time you make a contact with a contact, you can write a note that summarizes the
