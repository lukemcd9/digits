...
import { Contacts, ContactSchema } from '../../api/contact/Contact';
...
class EditContact extends React.Component {
  ...
  submit(data) {
    const { firstName, lastName, address, description, image, _id } = data;
    Contacts.update(_id, { $set: { firstName, lastName, address, description, image } }, (error) => (error ?
